...
use super::missions_snapshot::{
    build_active_mission_row_snapshot, build_mission_modal_snapshot,
    build_station_missions_snapshot, ActiveMissionRowSnapshot, MissionModalSnapshot,
...
pub struct StationMarketAnomalySnapshot {
    ...
    pub population_trend: gatebound_sim::PopulationTrend,
    pub price_index: f64,
    pub stock_coverage: f64,
    pub net_flow: f64,
...
fn build_station_anomaly_snapshot(
    ...
    StationMarketAnomalySnapshot {
        ...
        population_ratio: row.population_ratio,
...
fn build_station_detail_snapshot(
    ...
    Some(MarketsStationDetailSnapshot {
        ...
        population_ratio: detail.population_ratio,
...
fn build_system_station_snapshot(
    ...
    SystemStationSnapshot {
        ...
        population_ratio: station.population_ratio,
        population_trend: station.population_trend,
...
pub(super) fn system_ref_snapshot(system_id: SystemId) -> SystemRefSnapshot {
    SystemRefSnapshot {
        system_id,
...
pub(super) fn station_ref_snapshot(
    simulation: &Simulation,
...
pub(crate) fn build_station_card_snapshot_for_ui(
    ...
    Some(StationCardSnapshot {
        ...
        population_ratio: trade.population_ratio,
        population_trend: trade.population_trend,
        station_x: station.x,
        station_y: station.y,
        docked: trade.docked,
        trade,
